    ...
    >
      <SidebarHeader className="border-b border-white/8 px-4 py-4">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
            className="group h-auto rounded-xl px-2 py-2 data-[slot=sidebar-menu-button]:p-0!"
            >
            <div className="flex items-center gap-2.5">
                <div className="flex size-8 items-center justify-center rounded-xl bg-white/6 ring-1 ring-white/10">
                  ...
                  >
                    ...
                    {item.value ? (
                      <span className="flex items-center gap-1 text-amber-400">
                        <IconStar className="size-3.5 fill-amber-400" />
      ...
      <SidebarFooter className="border-t border-white/8 p-3">
        <Button
          ...
          className="h-11 w-full rounded-2xl bg-red-500 font-medium text-white shadow-sm transition hover:bg-red-600"
        >
          Clear filters
        </Button>
      </SidebarFooter>
